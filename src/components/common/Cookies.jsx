          ...
          <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      ...
                      provide enhanced, more personal features. They may be set
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      We use browser local storage to save your resume data
                      directly on your device. This ensures your work is
                      preserved between sessions without sending data to our
                      servers.
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>
                    Browser Settings: Most browsers allow you to view, delete,
                    and block cookies
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2 mt-4">
                  ...
                  <li>
                    <strong>Persistent Cookies:</strong> Remain until they
                    expire or you delete them
                  </li>
                  <li>
                    <strong>Local Storage:</strong> Persists until manually
                    cleared
                  </li>
                </ul>
              </section>
