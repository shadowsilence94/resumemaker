            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-300">
                  By accessing and using Easy Resume, you accept and agree to be
              ...
              <section>
                ...
                <p className="text-gray-300 mb-4">
                  Easy Resume is a web-based resume building platform that
                  allows users to create, edit, and download professional
                  resumes using various templates.
                </p>
                <p className="text-gray-300">
              ...
              <section>
                ...
                <p className="text-gray-300 mb-4">
                  The Easy Resume platform, including its design, templates, and
                  functionality, is owned by us and protected by copyright and
                  other intellectual property laws.
                </p>
                <p className="text-gray-300">
                  You retain ownership of the content you create using our
                  service, but grant us a license to use it for the purpose of
              ...
              <section>
                ...
                <p className="text-gray-300 mb-4">
                  Easy Resume shall not be liable for any indirect, incidental,
