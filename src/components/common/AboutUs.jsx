...
const AboutUs = () => {
  const features = [
    ...
    },
    {
      ...
      icon: <FaDownload className="text-3xl text-indigo-600 dark:text-indigo-400" />,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            We're on a mission to help professionals create stunning resumes that get them hired. 
            Our platform combines beautiful design with powerful functionality to make resume building 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              We've built the most intuitive and powerful resume builder to help you succeed
            </p>
          </motion.div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    {[
                      { icon: <FaLinkedin />, link: member.social.linkedin, color: "text-blue-600" },
                      { icon: <FaGithub />, link: member.social.github, color: "text-gray-700 dark:text-gray-300" }
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
              ...
              easy-to-use tools that help everyone present their best professional self. 
              We believe that everyone deserves access to beautiful, effective resume design 
